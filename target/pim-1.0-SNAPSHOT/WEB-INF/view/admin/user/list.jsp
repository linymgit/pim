        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                for (let i in l) {
                    ...
                    h += '<td >' + l[i].id + '</td>';
                    h += '<td >' + handlerUndefine(l[i].name) + '</td>';
                    h += '<td >' + handlerUndefine(l[i].relname) + '</td>';
                    h += '<td >' + convertSex(l[i].sex) + '</td>';
                    h += '<td ><img src=\'' + l[i].avatar + '\' style="width: 3.5rem;height: 3.5rem;border-radius: 50%"></td>';
                    h += '<td >' + handlerUndefine(l[i].phone) + '</td>';
                    h += '<td >' + handlerUndefine(l[i].email) + '</td>';
                    h += '<td >' + handlerUndefine(l[i].job) + '</td>';
                    h += '<td >' + handlerUndefine(l[i].address) + '</td>';
                    h += '<td >' + handlerUndefine(l[i].banTime) + '</td>';
                    h += '</tr>'
                }
                $("#yimi-table").append(h);
